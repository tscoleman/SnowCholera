...
We could do the same analsis for Table VII (the first 4 weeks of the 1854 outbreak). The code chunk below performs those calculations but does not print the results. 
