...
Clean water effect in ratio terms - Expressed as decrease (Southwark -> Lambeth) it is `r round(exp(diff_in_diffs_Log[3,3]),3)` and as increase (Lambeth -> Southwark) it is: `r round(exp(-diff_in_diffs_Log[3,3]),3)`.
